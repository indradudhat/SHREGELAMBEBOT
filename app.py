...
# ============================
# તમારી Keys અહીં નાખો
# ============================
CLAUDE_API_KEY = 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
META_ACCESS_TOKEN = IGAAONFjtqWB9BZAFpodUY0SUtFWHB4ckRFeDBiWXpjU0pfSThrU2NNOXlvaW5xeDlPNG5zdUVySldmX2loZADMzaldYVldCSi1wN05hSVhrWUk0eGotUnhBZAFMwT3czRlZAmMTJMM1FFMHlRU0FacmNwQjhBbURZAUHFBYmtiZAjc1QQZDZD
VERIFY_TOKEN = "tulsimalavbot2024"
...
# System Prompt
# ============================
SYSTEM_PROMPT = """તમે "મેલડી માતા પેડલ તુલસી માળા" ના Instagram Sales Bot છો.

📦 PRODUCT:
- નામ: મેલડી માતા પેડલ તુલસી માળા
- કિંમત: ₹750
...
4. Order confirm કરો:
   ...
   Address: [address]
   Pincode: [pincode]
   Product: મેલડી માતા પેડલ તુલસી માળા
...
મેલડી માતા પેડલ તુલસી માળા માં આપનું સ્વાગત છે! 🌿

અમારી પાસે છે:
📿 મેલડી માતા પેડલ તુલસી માળા
💰 કિંમત: માત્ર ₹750
🚚 Delivery: 5-6 દિવસ
